...
namespace EFWinforms
{
        ...
        IExtenderProvider
    {
        ...
        public EntitySetCollection EntitySets { get; } = new EntitySetCollection();
        ...
        public int SaveChanges()
        {
            ...
            if (!e.Cancel)
            {
                try
                {
                    ...
                    Debug.WriteLine("Done. {0} changes saved.", count);
        ...
        /// <remarks>
        ///     <para>
        ///         The lookup dictionary has keys that correspond to the items on a list and
        ///         values that contain a string representation of the items.
        ///     </para>
        ///     <para>
        ///         When lists of entities are sorted on a column that contains entity references,
        ...
        ///         the order in which the categories are compared while sorting.
        ///     </para>
        ///     <para>
        ///         Lookup dictionaries are especially useful for setting the DataMap property on the
        ...
        ///         for editing the cell values.
        ///     </para>
        ///     <para>
        ///         If you add a C1FlexGrid control to a form that contains a
        ...
        ///         dictionaries to their columns automatically.
        ///     </para>
        /// </remarks>
        public ListDictionary GetLookupDictionary(Type elementType)
        {
            return (from es in EntitySets where es.ElementType == elementType select es.LookupDictionary).FirstOrDefault();
        }
        ...
        /// <param name="autoLookups">
        ///     Whether to enable or disable automatic data maps for the columns on the
        ///     <paramref name="grid" /> control.
        /// </param>
        ...
        private static void CustomizeGrid(Control ctl)
        {
            dynamic grid = ctl;
