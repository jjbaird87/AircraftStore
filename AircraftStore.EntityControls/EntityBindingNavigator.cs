...
namespace EFWinforms
{
        ...
        ToolStrip
    {
        ...
        public override sealed DockStyle Dock
        {
        ...
        void UpdateUi()
        {
            if (_cm != null)
            {
                _lblCurrent.Text = $"{_cm.Position + 1} of {_cm.Count}";
        ...
        void _btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (_cm?.List is IBindingList && !ce.Cancel)
            {
                // add new
        ...
        void _btnRemove_Click(object sender, EventArgs e)
        {
            ...
            if (_cm?.Current != null && _cm.List is IBindingList && !ce.Cancel)
            {
                // remove current item
                var bl = (IBindingList) _cm.List;
        ...
        EntityDataSource EntityDataSource => _dataSource as EntityDataSource;
